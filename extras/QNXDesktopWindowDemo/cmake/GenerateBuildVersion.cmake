...
if (NOT DEFINED ROOT)
    message(FATAL_ERROR "ROOT must point at the JUCE repository root")
endif()
...
set(version_file "${ROOT}/extras/QNXDesktopWindowDemo/BuildVersion.txt")
...
"#pragma once\n"
"#define JUCE_QNX_DESKTOP_WINDOW_DEMO_BUILD_NUMBER ${next_build_number}\n"
"#define JUCE_QNX_DESKTOP_WINDOW_DEMO_BUILD_VERSION \"${next_build_version}\"\n")

message(STATUS "Generated JUCE QNX Desktop Window Demo build version ${next_build_version}")
