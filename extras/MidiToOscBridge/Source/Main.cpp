...
namespace
{
    constexpr int defaultOscPort = 9001;
    constexpr auto defaultTargetAddress = "192.168.0.2";
...
public:
    MainComponent()
    {
        ...
        titleLabel.setText ("MIDI To OSC Bridge", juce::dontSendNotification);
        ...
        schemaLabel.setText ("Forwarded OSC: /juce/noteOn <note:int> <velocity:float> and /juce/noteOff <note:int>",
...
private:
    ...
    void handleIncomingMidiMessage (juce::MidiInput* source, const juce::MidiMessage& message) override
    {
        ...
        if (message.isNoteOn())
        {
            ...
            sendOscMessage (juce::OSCMessage ("/juce/noteOn", noteNumber, velocity));
        ...
        {
            sendOscMessage (juce::OSCMessage ("/juce/noteOff", noteNumber));
...
class MidiToOscBridgeApplication final : public juce::JUCEApplication
{
public:
    const juce::String getApplicationName() override       { return "JUCE MIDI To OSC Bridge"; }
...
START_JUCE_APPLICATION (MidiToOscBridgeApplication)
