...
set(CMAKE_AR "${QNX_BIN_DIR}/ntoaarch64-ar.exe" CACHE FILEPATH "")
set(CMAKE_RANLIB "${QNX_BIN_DIR}/ntoaarch64-ranlib.exe" CACHE FILEPATH "")
set(CMAKE_NM "${QNX_BIN_DIR}/ntoaarch64-nm.exe" CACHE FILEPATH "")
set(CMAKE_OBJCOPY "${QNX_BIN_DIR}/ntoaarch64-objcopy.exe" CACHE FILEPATH "")
set(CMAKE_OBJDUMP "${QNX_BIN_DIR}/ntoaarch64-objdump.exe" CACHE FILEPATH "")
set(CMAKE_STRIP "${QNX_BIN_DIR}/ntoaarch64-strip.exe" CACHE FILEPATH "")
...
set(QNX_COMMON_DEFINES "-D__EXT_QNX -D__EXT_UNIX_MISC" CACHE INTERNAL "")

set(CMAKE_C_FLAGS_INIT
    "-V${QNX_TARGET_TRIPLE} -I\"${QNX_COMPAT_INCLUDE_DIR}\" ${QNX_COMMON_DEFINES}"
    CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_INIT
    "-V${QNX_TARGET_TRIPLE} -I\"${QNX_COMPAT_INCLUDE_DIR}\" ${QNX_COMMON_DEFINES} -include strings.h -DM_PI=3.14159265358979323846"
    CACHE STRING "" FORCE)
set(CMAKE_EXE_LINKER_FLAGS_INIT "-V${QNX_TARGET_TRIPLE}" CACHE STRING "" FORCE)
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-V${QNX_TARGET_TRIPLE}" CACHE STRING "" FORCE)
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-V${QNX_TARGET_TRIPLE}" CACHE STRING "" FORCE)
