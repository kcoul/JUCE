...
set(version_file "${ROOT}/extras/FrameRateBench/BuildVersion.txt")
...
"#pragma once\n"
"#define JUCE_FRAME_RATE_BENCH_BUILD_NUMBER ${next_build_number}\n"
"#define JUCE_FRAME_RATE_BENCH_BUILD_VERSION \"${next_build_version}\"\n")

message(STATUS "Generated JUCE Frame Rate Bench build version ${next_build_version}")
